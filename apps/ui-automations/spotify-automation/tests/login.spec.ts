...
test.describe('Spotify for Creators - Authenticated Access', () => {
  ...
  test('should be able to access a protected page (e.g., dashboard)', async ({ page }) => {
  ...
  test('should redirect from login page to dashboard if already logged in', async ({ page }) => {
